...
if __name__ == "__main__":
    ...
    # test_fout = "./snli_test_c2n1e_test.json"
    # test_data = load_file("./snli_test_c2n1e.csv", GLOBAL_MAP['snli'])
    # for i in range(len(test_data)):
    #     print(test_data[i])
    # print("LEN: ", len(test_data))
    # build_data(test_data, test_fout)

    test_fout = "./snli_train_c2n1e_test.json"
    test_data = load_file("./snli_train_c2n1e.csv", GLOBAL_MAP['snli'])
    for i in range(len(test_data)):
        print(test_data[i])
    print("LEN: ", len(test_data))
    build_data(test_data, test_fout)
